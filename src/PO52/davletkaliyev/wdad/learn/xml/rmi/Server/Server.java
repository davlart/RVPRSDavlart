...
//    static final private String EXECUTOR_NAME = "mySuperPuperExecutor";
    ...
    public static void main(String[] args) throws Exception {
       ...
       // System.setProperty("java.rmi.server.useCodebaseOnly", "true"); // искать классы в codebase, а не в class path
        ...
        System.setProperty("java.security.policy", prefManager.getProperty(PreferencesConstantManager.POLICYPATH)); // путь к файлу с правами доступа
        ...
        try {
            ...
            //если реестр запущен
            registry = LocateRegistry.createRegistry(Integer.parseInt(prefManager.getProperty(PreferencesConstantManager.REGISTRYPORT)));
            // Remote stub =  UnicastRemoteObject.exportObject(xdmi, 0);
            registry.rebind(prefManager.getName("DataManager"), xdmi);
            prefManager.addBindedObject("DataManager", DataManager.class.getCanonicalName());
